...
import { Mail, Lock, Eye, EyeOff, Zap, ShieldCheck, Users } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-[#eef1fb] px-4 py-4 sm:py-10 lg:justify-end lg:px-16 xl:px-24">
      ...
      {/* Mobile solid navy fallback (no diagonal, whole bg) */}
      ...
      <div className="relative z-10 hidden max-w-md flex-1 self-center text-white lg:flex lg:flex-col lg:pr-12">
        ...
        <h1 className="mt-10 text-4xl font-bold leading-tight xl:text-[44px]">
          Sign in to <br />
          your <span className="text-orange">workspace</span>
        </h1>
        <p className="mt-4 text-sm text-white/90 xl:text-base">
          Your growth partner&apos;s content, tasks &amp; review workspace
        </p>
        ...
        <div className="mt-auto flex items-center gap-3 pt-24 text-xs text-white/60">
      ...
      {/* Floating card */}
        ...
        <div className="rounded-2xl bg-white p-6 shadow-[0_25px_60px_-15px_rgba(15,23,42,0.35)] sm:p-8">
          ...
          <h2 className="mt-6 text-2xl font-bold text-navy-900">Sign in</h2>
          ...
          {/* <div className="mt-6 border-t border-navy-100 pt-4 text-xs text-navy-400">
            <p className="font-semibold text-navy-600">Demo logins (password: Password123!)</p>
            <ul className="mt-1.5 space-y-0.5">
              <li className="flex justify-between"><span>admin@demo.agency</span><span>— admin</span></li>
              <li className="flex justify-between"><span>manager@demo.agency</span><span>— manager</span></li>
              <li className="flex justify-between"><span>designer@demo.agency</span><span>— team member</span></li>
              <li className="flex justify-between"><span>freelancer@demo.agency</span><span>— freelancer</span></li>
              <li className="flex justify-between"><span>client@zenithfoods.com</span><span>— client</span></li>
            </ul>
          </div> */}

          <p className="mt-4 text-center text-xs text-navy-300">
            Setting up a brand-new agency?{" "}
            <Link href="/register-agency" className="font-medium text-orange hover:underline">
              Create a workspace
            </Link>
          </p>
        </div>
